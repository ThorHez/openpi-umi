...
RAW_ROOT=${ROBOSUITE_ROOT}/outputs/shellgame_onpolicy_eef_continuous_descent_v4_balanced1200_260815
...
LOG=${OPENPI_ROOT}/generate_eef_continuous_descent_v4_parallel_balanced1200_260815.log
SERVER_LOG=${OPENPI_ROOT}/serve_eef_continuous_descent_v4_parallel_balanced1200_260815.log
UV_CACHE_DIR=${WORKSPACE}/.codex_tmp/uv_cache
JAX_COMPILATION_CACHE_DIR=${WORKSPACE}/.codex_tmp/jax_cache_eef_continuous_descent_v4_1200
...
exec >>"${LOG}" 2>&1
echo "[$(date --iso-8601=seconds)] Starting balanced 1200-episode V4 generation"
echo "raw=${RAW_ROOT}"
