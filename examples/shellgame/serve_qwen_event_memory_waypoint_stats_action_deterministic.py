#!/usr/bin/env python3
"""Serve the V2 memory-statistics waypoint policy with fixed noise."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_action_frame59_waypoint_stats as recipe
...
DEFAULT_CHECKPOINT = Path(
    "checkpoints/pi0_shellgame_qwen_distilled_memory_action_frame59_waypoint_stats_eef7_260826/"
    "direct_visual_frame59_waypoint_stats500_4gpu_260826/499"
)
...
def main() -> None:
    ...
    logging.info("Loaded V2 waypoint policy from %s", checkpoint)
