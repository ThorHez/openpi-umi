#!/usr/bin/env python3
"""Distill old V10 memory residuals into its semantic-memory adapter."""
...
from openpi.training.mem.recipes import (  # noqa: E402
    shellgame_v10_semantic_residual_distillation as _recipe,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mse-fraction", type=float, default=0.5)
...
def main() -> None:
    ...
    config = _recipe.make_train_config(
        ...
        mse_fraction=args.mse_fraction,
