#!/usr/bin/env python3
"""Train the balanced frame-241 M6 direction stage with 32-step chunks."""
...
from openpi.training.mem.recipes import shellgame_real_wrist_m6_direction_stage1_h32 as _recipe  # noqa: E402
...
def main() -> None:
    ...
    print(
        "M6 direction H32: deployed interface, frame=241 only, exact class-balanced split, "
        f"flow loss + {args.direction_loss_weight:g}*direction_CE, global_batch={args.batch_size}, "
        f"devices={args.fsdp_devices}",
        flush=True,
    )
