#!/usr/bin/env python3
"""Train the frozen-V6 current-visual XY correction head."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_waypoint_visual_correction_v6 as _recipe
