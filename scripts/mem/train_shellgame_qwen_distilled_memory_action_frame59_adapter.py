#!/usr/bin/env python3
"""Train only the external-MEM conditioner on ShellGame frame-59 actions."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_action_frame59_adapter as _recipe
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--init-checkpoint",
        type=pathlib.Path,
        default=_recipe.DEFAULT_INIT_CHECKPOINT,
    )
