#!/usr/bin/env python3
"""Jointly fine-tune the MEM conditioner and Pi action expert at frame 59."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_action_frame59_joint as _recipe
