#!/usr/bin/env python3
"""Distill V10 on the four-step diffusion trajectory visited by the student."""
...
from openpi.training.mem.recipes import (  # noqa: E402
    shellgame_v10_semantic_onpolicy_diffusion_distillation as _recipe,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--init-checkpoint", type=pathlib.Path, default=_recipe.DEFAULT_INIT_CHECKPOINT
    )
    parser.add_argument("--steps", type=int, default=250)
    parser.add_argument("--peak-lr", type=float, default=1e-5)
    parser.add_argument("--onpolicy-num-steps", type=int, default=4)
    parser.add_argument("--onpolicy-velocity-weight", type=float, default=1.0)
    parser.add_argument("--batch-size", type=int, default=3)
    parser.add_argument("--fsdp-devices", type=int, default=3)
    parser.add_argument("--num-workers", type=int, default=8)
    parser.add_argument("--checkpoint-period", type=int, default=125)
...
def main() -> None:
    args = parse_args()
    banks = dict(_memory_data.DEFAULT_MEMORY_BANKS)
    config = _recipe.make_train_config(
        ...
        onpolicy_num_steps=args.onpolicy_num_steps,
        onpolicy_velocity_weight=args.onpolicy_velocity_weight,
