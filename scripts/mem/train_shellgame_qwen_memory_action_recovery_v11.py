#!/usr/bin/env python3
"""Train action-only V11 adaptation on current-policy coherent recovery."""
...
from openpi.training.mem.recipes import shellgame_qwen_memory_action_recovery_v11 as _recipe
