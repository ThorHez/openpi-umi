#!/usr/bin/env python3
"""Distill V10 final diffusion velocity into its semantic-memory adapter."""
...
from openpi.training.mem.recipes import (  # noqa: E402
    shellgame_v10_semantic_velocity_distillation as _recipe,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--velocity-distillation-weight", type=float, default=1.0)
...
def main() -> None:
    ...
    config = _recipe.make_train_config(
        ...
        velocity_distillation_weight=args.velocity_distillation_weight,
