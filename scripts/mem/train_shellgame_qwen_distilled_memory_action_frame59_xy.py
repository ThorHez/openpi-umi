#!/usr/bin/env python3
"""Fine-tune frame-59 memory-to-action alignment using only absolute EEF XY."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_action_frame59_xy as _recipe
