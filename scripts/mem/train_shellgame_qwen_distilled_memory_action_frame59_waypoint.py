#!/usr/bin/env python3
"""Train the continuous frame-59 memory waypoint bridge."""
...
from openpi.training.mem.recipes import shellgame_qwen_distilled_memory_action_frame59_waypoint as _recipe
