...
def main(
    ...
    *,
    ...
    data_loader: _data_loader.DataLoader | None = None,  # If provided, use this instead of creating from config
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fast_warmup_steps", type=int, default=10,
