"""Adapter-only V10 final-velocity distillation recipe."""
...
from examples.shellgame import v10_exact_semantic_velocity_distillation as _distill
...
DEFAULT_INIT_CHECKPOINT = pathlib.Path(
    ...
    "pi0_shellgame_v10_semantic_residual_distillation_eef7_260827/"
    "v10_semantic_residual_distill_from375_w01_250_b12_6gpu_260827/249/params"
)
...
def make_train_config(
    *,
    ...
    return dataclasses.replace(
        parent,
        name="pi0_shellgame_v10_semantic_velocity_distillation_eef7_260827",
        model=model,
